            ...
            <form onSubmit={handleSubmit} className='row  lg:flex md:flex mt-10'>
                ...
                <div className="lg:w-2/3 md:w-2/3 md:mt-5 lg:mt-5 mt-5 md:gap-2 lg:gap-2 md:p-4 lg:p-4 gap-4 ">
                    ...
                    <div className="flex flex-col lg:flex-row  md:flex-row w-full gap-5 mt-5">
                        <input onChange={handleChange} name='name' value={formData.name} type="text" placeholder="Enter your name" className="rounded-xl form-control lg:py-5 md:py-5 py-3 font-light text-sm bg-gray-200 font-poppins md:w-1/2 lg:w-1/2 p-2" />
                        <input onChange={handleChange} name='email' value={formData.email} type="text" placeholder="Enter your email" className="rounded-xl form-control lg:py-5 md:py-5 py-3 font-light text-sm bg-gray-200 font-poppins md:w-1/2 lg:w-1/2 p-2" />
                    </div>
                    <textarea onChange={handleChange} name='message' value={formData.message} rows={5} cols={7} placeholder="Enter your message" className="rounded-lg form-control font-light text-sm bg-gray-200 font-poppins mt-3 w-full p-4"></textarea>
